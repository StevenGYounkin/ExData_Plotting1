...
###create Plot 4, save as plot4.png
par(mfcol = c(2,2))
###create upper left panel
plot(PlotTime2,Target_Data$Global_active_power,xlab = "",ylab = "Global Active Power", "l")
...
plot(PlotTime2,Target_Data$Global_reactive_power,xlab ="datetime" ,ylab = "Global_reactive_power", "l")
